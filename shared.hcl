...
prod_acct_email     = "aws+prod@your_organization.biz"
non_prod_acct_email = "aws+non-prod@your_organization.biz"
...
# update this after the initial run
#infosec_account_id = "000000000000"